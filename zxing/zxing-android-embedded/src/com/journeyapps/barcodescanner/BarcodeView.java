...
public class BarcodeView extends CameraPreview {
    ...
    private BarcodeView.DecodeMode decodeMode = BarcodeView.DecodeMode.NONE;
    ...
    private final Handler.Callback resultCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            if (message.what == R.id.zxing_decode_succeeded) {
                ...
                if (result != null) {
                    if (callback != null && decodeMode != BarcodeView.DecodeMode.NONE) {
                        callback.barcodeResult(result);
                        if (decodeMode == BarcodeView.DecodeMode.SINGLE) {
                            stopDecoding();
                        }
                    }
                }
    ...
    private void startDecoderThread() {
        ...
        if (decodeMode != BarcodeView.DecodeMode.NONE && isPreviewActive()) {
