...
public class CameraPreview extends ViewGroup {
    ...
    private List<CameraPreview.StateListener> stateListeners = new ArrayList<>();
     ...
     */
    public void addStateListener(CameraPreview.StateListener listener) {
    ...
    private final CameraPreview.StateListener fireState = new CameraPreview.StateListener() {
        ...
        public void previewSized() {
            for (CameraPreview.StateListener listener : stateListeners) {
