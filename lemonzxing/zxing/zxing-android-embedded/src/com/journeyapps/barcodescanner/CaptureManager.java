...
public class CaptureManager {
    ...
    private ScanResultCallback scanResultDelegate;
    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(final BarcodeResult result) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
//                    returnResult(result);
                    ((ScanResultCallback)activity).onScanResultCallback(result);
                }
            });
    ...
    public CaptureManager(Activity activity, DecoratedBarcodeView v) {
...
//
//        //TODO: 깔끔한 오브젝트를 전달해주자.
//        ((ScanResultCallback)activity).onScanResultCallback(rawResult);
//    }
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        CaptureManager.setCameraPermissionReqCode(cameraPermissionReqCode);
    }
